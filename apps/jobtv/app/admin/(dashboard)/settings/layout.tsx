...
export default function AdminSettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs = [
    { name: "ユーザー設定", icon: User, href: "/admin/settings/user" },
    { name: "管理者アカウント一覧", icon: UserCog, href: "/admin/settings/users" },
  ];
  ...
  return (
    <div className="space-y-10">
      <div>
        ...
        <p className="text-gray-500 font-medium">管理者アカウントの設定を管理します。</p>
      </div>
