...
export default function CompanyPageManagement() {
  ...
  const {
    ...
    validate: () => {
      ...
      // おすすめポイントは各項目30文字以内
      const hasBenefitErrors = (company.benefits || []).some((b) => b.length > TITLE_MAX_LENGTH);
      if (hasBenefitErrors) {
        return "入力内容を確認してください";
      }
      // 必須項目のチェック
      ...
      if (!company.coverImage || company.coverImage.trim() === "") {
        return "カバー画像は必須項目です";
      }
      return null;
    }
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (name === "tagline") {
      ...
      const maxLengthError = validateMaxLength(value, TITLE_MAX_LENGTH, "キャッチコピー");
    ...
    if (name === "description") {
      ...
      const maxLengthError = validateMaxLength(value, LONG_DESCRIPTION_MAX_LENGTH, "会社紹介文");
    ...
    <div className="space-y-10 pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          ...
          <SectionCard
            ...
            title="カバー画像"
            badge={<StudioBadge variant="error">必須</StudioBadge>}
          >
      ...
      <DraftActionButtons
        ...
        isSubmitDisabled={
          ...
          !!taglineError ||
          !!descriptionError ||
          (company.benefits || []).some((b) => b.length > TITLE_MAX_LENGTH) ||
          !company.coverImage ||
          company.coverImage.trim() === ""
        }
